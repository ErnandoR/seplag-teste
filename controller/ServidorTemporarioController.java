...
public class ServidorEfetivoController {
    ...
    public ResponseEntity<Page<ServidorEfetivoDTO>> porUnidade(@PathVariable Long unidadeId, Pageable pageable) {
        return ResponseEntity.ok(service.buscarPorUnidade(unidadeId, pageable));
    }

    @GetMapping("/endereco-funcional")
    public ResponseEntity<Page<String>> buscarEnderecoFuncionalPorNome(@RequestParam String nome, Pageable pageable) {
        return ResponseEntity.ok(service.buscarEnderecosFuncionais(nome, pageable));
    }
}
